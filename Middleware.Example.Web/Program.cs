using Middleware.Example.Web.Middlewares;
...
//    await next();
//    await context.Response.WriteAsync("After 3. Middleware\n");
//});
...
#region Map ve MapWhen Kullanýmý
...
// Oluþturduðumuz Middleware ekledik.
